...
function export_version_vars () {
    ...
    export CAOS_DASHBOARD_DOCKER_IMAGE_TAG="${CI_REGISTRY_IMAGE}:${CAOS_DASHBOARD_RELEASE_GIT_VERSION}-${CI_COMMIT_REF_SLUG}-${BUILD_TARGET}"
    export CAOS_DASHBOARD_RELEASE_DOCKER_IMAGE_TAG="${CI_REGISTRY_IMAGE}:${CAOS_DASHBOARD_RELEASE_GIT_VERSION}"
}
